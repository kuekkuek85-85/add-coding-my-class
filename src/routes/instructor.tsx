      ...
      <section className="mx-auto max-w-6xl px-4 py-6">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          <div className="chalkboard p-6 lg:col-span-2">
            <p className="mb-2 text-xs uppercase tracking-widest text-primary">참가자 입장 코드</p>
            <div className="flex items-baseline gap-3">
              <KeyRound className="h-6 w-6 text-primary" aria-hidden />
              {data?.ok ? (
                <span className="font-display text-4xl font-bold tracking-[0.2em] text-foreground sm:text-5xl">
