...
function S1Page() {
  ...
  if (snap?.ok && currentStage < 1) {
    return (
      <main className="mx-auto max-w-2xl px-4 py-16 text-center">
        <Lock className="mx-auto mb-3 h-8 w-8 text-muted-foreground" aria-hidden />
        <h1 className="mb-2 font-display text-xl font-bold">1교시가 아직 열리지 않았습니다</h1>
      ...
      <header className="border-b-2 border-primary/15 bg-card/60 backdrop-blur">
        <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-between gap-3 px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="font-display text-sm font-bold text-primary">S1 · 1교시 — 기본 기능 떠올리기</p>
              <p className="text-xs text-muted-foreground">체크포인트 통과 · 내 수업이라면 메모</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
