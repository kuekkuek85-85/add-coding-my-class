...
const S3: SlideDef[] = [
  ...
  },
  {
    ...
    kind: "closing",
    kicker: "다음 교시 예고",
    title: "4교시 · 초안 PRD를 프롬프트로 다듬기",
    subtitle:
      "3교시에서 확정한 PRD 초안을 그대로 이어받아, 테스트 케이스 3개 이상을 먼저 쓰고 초안 PRD 전체를 프롬프트로 다듬어 확정합니다.",
  },
];

// ────────────────────────────────────────────────────────────────────
// S4 · 4교시 — TDD + 초안 PRD 수정
// ────────────────────────────────────────────────────────────────────
const S4: SlideDef[] = [
  {
    id: "s4-01-open",
    kind: "title",
    kicker: "S4 · 4교시",
    title: "테스트가 먼저, PRD는 그다음에 다듬기",
    subtitle: "합격 조건을 먼저 못 박고, 3교시 초안 PRD 전체를 프롬프트로 다듬어 확정합니다.",
  },
  {
    id: "s4-02-terms",
    kind: "stat",
    kicker: "용어 정리",
    title: "TDD와 PRD 프롬프트, 어렵게 부르지 않기",
    stats: [
      {
        value: "TDD",
      ...
      {
        value: "PRD 프롬프트",
        label: "초안 PRD 문서를 그대로 AI에게 넘길 지시문",
        caption: "칸을 새로 채우는 게 아니라, 3교시 초안 PRD 전체 텍스트를 직접 수정합니다.",
      },
      {
        value: "합격 PRD 프롬프트",
        label: "내 테스트 3개를 모두 통과한 PRD 프롬프트",
        caption: "통과할 때까지 PRD를 고칩니다. 테스트는 건드리지 않습니다.",
      },
    ],
  },
  {
    ...
    bullets: [
      ...
      {
        title: "초안 PRD 수정하기",
        caption: "3교시 PRD 전체가 입력창에 채워집니다. 문장을 직접 다듬어 최종 PRD 프롬프트를 만듭니다.",
      },
      {
        title: "직접 돌려보고 통과 여부를 표시",
        caption: "실패하면 PRD 프롬프트를 고칩니다 — 테스트는 그대로 둡니다.",
      },
    ],
  },
  {
    ...
    compare: {
      left: {
        label: "AI에게 부탁 OK",
        items: [
          "이 PRD 프롬프트를 어떻게 개선할지 '아이디어'만 묻기",
  ...
  },
  {
    ...
    subtitle:
      "확정한 PRD 프롬프트로 만든 결과물을 배포해 URL을 제출하고, 옆 선생님과 교차로 실행 체크리스트를 돌립니다.",
  },
];
